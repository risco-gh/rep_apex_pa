...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23450757473010578)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23451004719010578)
,p_plug_template_id=>wwv_flow_imp.id(23450757473010578)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23451319690010578)
,p_plug_template_id=>wwv_flow_imp.id(23450757473010578)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23451660147010578)
,p_plug_template_id=>wwv_flow_imp.id(23450757473010578)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23451980974010577)
,p_plug_template_id=>wwv_flow_imp.id(23450757473010578)
,p_name=>'Sub Regions'
