...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(23417752321010605)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23418044176010604)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23418331639010604)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23418634682010604)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23418980374010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23419260461010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23419554027010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23419898678010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23420179858010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23420481104010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23420723499010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23421058366010603)
,p_page_template_id=>wwv_flow_imp.id(23417752321010605)
