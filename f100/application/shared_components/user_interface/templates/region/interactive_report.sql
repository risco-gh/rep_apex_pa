...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23507581296010548)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23507870382010548)
,p_plug_template_id=>wwv_flow_imp.id(23507581296010548)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23508155976010548)
,p_plug_template_id=>wwv_flow_imp.id(23507581296010548)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23508479258010548)
,p_plug_template_id=>wwv_flow_imp.id(23507581296010548)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23508748923010547)
,p_plug_template_id=>wwv_flow_imp.id(23507581296010548)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23509090308010547)
,p_plug_template_id=>wwv_flow_imp.id(23507581296010548)
,p_name=>'Sub Regions'
