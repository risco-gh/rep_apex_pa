...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23497567944010553)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23497849569010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23498190353010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23498411620010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23498711447010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23499050077010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23499342594010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23499622862010553)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23499925704010552)
,p_plug_template_id=>wwv_flow_imp.id(23497567944010553)
,p_name=>'Sub Regions'
