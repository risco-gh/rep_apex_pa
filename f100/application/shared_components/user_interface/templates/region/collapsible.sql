...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23484228382010560)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23484518159010560)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23484823370010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23485128799010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23485428290010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23485759076010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23486009223010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23486366824010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23486680880010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23486961353010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23487208532010559)
,p_plug_template_id=>wwv_flow_imp.id(23484228382010560)
,p_name=>'Sub Regions'
