...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23529741754010537)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23530005454010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23530378813010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23530674259010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23530978759010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23531276039010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23531558530010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23531895838010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23532125260010537)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23532492874010536)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23532746981010536)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23533038651010536)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23533399230010536)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23533696109010536)
,p_plug_template_id=>wwv_flow_imp.id(23529741754010537)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
