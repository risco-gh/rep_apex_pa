...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23607792206010415)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23608015480010414)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23608322256010414)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23608617330010413)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23608938645010413)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23609219912010412)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23609539096010412)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23609835867010411)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23610158994010411)
,p_plugin_id=>wwv_flow_imp.id(23607792206010415)
,p_attribute_scope=>'COMPONENT'
