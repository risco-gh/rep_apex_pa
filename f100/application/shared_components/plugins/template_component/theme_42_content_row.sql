...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23652917593010329)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1950890802684082014)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1950890247672082013)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1693998183941808500)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23653812473010318)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23654147103010317)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23654444070010317)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23654706437010316)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23655029498010315)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23655328302010315)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23655681929010314)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23655029498010315)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1950890802684082014)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23655940478010314)
,p_plugin_attribute_id=>wwv_flow_imp.id(23655681929010314)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23656337459010313)
,p_plugin_attribute_id=>wwv_flow_imp.id(23655681929010314)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23656738135010313)
,p_plugin_attribute_id=>wwv_flow_imp.id(23655681929010314)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23657122851010312)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23655681929010314)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23657455023010312)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23657711910010311)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23658047865010311)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23658311830010310)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23658655031010310)
,p_plugin_attribute_id=>wwv_flow_imp.id(23658311830010310)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23659073692010309)
,p_plugin_attribute_id=>wwv_flow_imp.id(23658311830010310)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23659495815010309)
,p_plugin_attribute_id=>wwv_flow_imp.id(23658311830010310)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23659898962010308)
,p_plugin_attribute_id=>wwv_flow_imp.id(23658311830010310)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23660297214010308)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(23655328302010315)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1950890247672082013)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23660516207010307)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23660895376010307)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23661191747010307)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23661411919010306)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23661765296010306)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23662018885010305)
,p_plugin_attribute_id=>wwv_flow_imp.id(23661765296010306)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23662476280010305)
,p_plugin_attribute_id=>wwv_flow_imp.id(23661765296010306)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23662894997010304)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23663189263010304)
,p_plugin_attribute_id=>wwv_flow_imp.id(23662894997010304)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23663502668010304)
,p_plugin_attribute_id=>wwv_flow_imp.id(23662894997010304)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23663970191010303)
,p_plugin_attribute_id=>wwv_flow_imp.id(23662894997010304)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23664395856010303)
,p_plugin_attribute_id=>wwv_flow_imp.id(23662894997010304)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23664709295010302)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23665047735010302)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23665489143010301)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23665820965010301)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23666278048010300)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23666630167010300)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23667029936010299)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23667424785010299)
,p_plugin_attribute_id=>wwv_flow_imp.id(23664709295010302)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23667896344010298)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23668177921010298)
,p_plugin_attribute_id=>wwv_flow_imp.id(23667896344010298)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23668590620010297)
,p_plugin_attribute_id=>wwv_flow_imp.id(23667896344010298)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23668983624010297)
,p_plugin_attribute_id=>wwv_flow_imp.id(23667896344010298)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23669350334010296)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23669643399010296)
,p_plugin_attribute_id=>wwv_flow_imp.id(23669350334010296)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23670087314010295)
,p_plugin_attribute_id=>wwv_flow_imp.id(23669350334010296)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23670491063010295)
,p_plugin_attribute_id=>wwv_flow_imp.id(23669350334010296)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23670876085010294)
,p_plugin_attribute_id=>wwv_flow_imp.id(23669350334010296)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23671201401010294)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23671523765010294)
,p_plugin_attribute_id=>wwv_flow_imp.id(23671201401010294)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23671932698010293)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23672288350010293)
,p_plugin_attribute_id=>wwv_flow_imp.id(23671932698010293)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23672683344010292)
,p_plugin_attribute_id=>wwv_flow_imp.id(23671932698010293)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23673070378010292)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1693998183941808500)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23673314484010291)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23673643668010291)
,p_plugin_attribute_id=>wwv_flow_imp.id(23673314484010291)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23674035850010290)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23674355345010290)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1832104692899903628)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1832105952419907776)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1535153178004145198)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1818511064225496895)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1819190364955579999)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1832102757832858642)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1832104091222872499)
,p_plugin_id=>wwv_flow_imp.id(23652917593010329)
