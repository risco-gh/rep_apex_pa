...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23592535781010477)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23592847494010459)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23593137881010457)
,p_plugin_attribute_id=>wwv_flow_imp.id(23592847494010459)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23593540279010455)
,p_plugin_attribute_id=>wwv_flow_imp.id(23592847494010459)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23593927224010455)
,p_plugin_attribute_id=>wwv_flow_imp.id(23592847494010459)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23594334394010454)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23592847494010459)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23594649026010453)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23594925677010453)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23595260801010453)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23595574974010448)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23595874119010447)
,p_plugin_attribute_id=>wwv_flow_imp.id(23595574974010448)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23596212861010447)
,p_plugin_attribute_id=>wwv_flow_imp.id(23595574974010448)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23596614907010446)
,p_plugin_attribute_id=>wwv_flow_imp.id(23595574974010448)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23597062459010446)
,p_plugin_attribute_id=>wwv_flow_imp.id(23595574974010448)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23597457270010445)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23597746164010445)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23598127320010444)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23598585917010444)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23598951094010443)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23599335267010442)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23599722584010442)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23600124608010441)
,p_plugin_attribute_id=>wwv_flow_imp.id(23597457270010445)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23600519907010441)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823643372197124223)
,p_plugin_id=>wwv_flow_imp.id(23592535781010477)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
