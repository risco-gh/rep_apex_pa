...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23527123811010539)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23527461979010538)
,p_plug_template_id=>wwv_flow_imp.id(23527123811010539)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23527776021010538)
,p_plug_template_id=>wwv_flow_imp.id(23527123811010539)
,p_name=>'Tabs'
