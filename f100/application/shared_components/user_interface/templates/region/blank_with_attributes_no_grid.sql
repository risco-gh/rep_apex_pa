...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23452111989010577)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23452438170010577)
,p_plug_template_id=>wwv_flow_imp.id(23452111989010577)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23452739173010577)
,p_plug_template_id=>wwv_flow_imp.id(23452111989010577)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23453073875010577)
,p_plug_template_id=>wwv_flow_imp.id(23452111989010577)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23453364639010577)
,p_plug_template_id=>wwv_flow_imp.id(23452111989010577)
,p_name=>'Sub Regions'
