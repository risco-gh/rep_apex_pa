...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23469041518010567)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23469350060010567)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23469642713010567)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23469985088010567)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23470264936010566)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23470571025010566)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23470801853010566)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23471196934010566)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23471414351010566)
,p_plug_template_id=>wwv_flow_imp.id(23469041518010567)
,p_name=>'Sub Regions'
