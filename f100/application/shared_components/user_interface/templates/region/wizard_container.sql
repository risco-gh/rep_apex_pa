...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23534831454010535)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23535157004010535)
,p_plug_template_id=>wwv_flow_imp.id(23534831454010535)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23535436265010535)
,p_plug_template_id=>wwv_flow_imp.id(23534831454010535)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23535776155010535)
,p_plug_template_id=>wwv_flow_imp.id(23534831454010535)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23536061807010535)
,p_plug_template_id=>wwv_flow_imp.id(23534831454010535)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23536307323010534)
,p_plug_template_id=>wwv_flow_imp.id(23534831454010535)
