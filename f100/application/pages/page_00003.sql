...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39947027702381278)
,p_plug_name=>'Params'
...
'union',
'select 5 value, ''param_5'' name, 5 ord from dual',
') order by ord'))
,p_plug_source_type=>'NATIVE_JET_CHART'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(600820519626407)
,p_region_id=>wwv_flow_imp.id(39947027702381278)
,p_chart_type=>'pie'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(602461811626413)
,p_chart_id=>wwv_flow_imp.id(600820519626407)
,p_seq=>10
,p_name=>'param_vals'
