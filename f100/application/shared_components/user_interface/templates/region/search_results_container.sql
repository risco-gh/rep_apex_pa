...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23514603734010545)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23514953973010545)
,p_plug_template_id=>wwv_flow_imp.id(23514603734010545)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23515203354010545)
,p_plug_template_id=>wwv_flow_imp.id(23514603734010545)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23515565983010545)
,p_plug_template_id=>wwv_flow_imp.id(23514603734010545)
,p_name=>'Sub Regions'
