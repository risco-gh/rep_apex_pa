...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(23414874545010622)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23415143961010613)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23415465162010612)
,p_page_template_id=>wwv_flow_imp.id(23414874545010622)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23415784761010612)
,p_page_template_id=>wwv_flow_imp.id(23414874545010622)
