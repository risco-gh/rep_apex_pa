...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23509689171010547)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23509969362010547)
,p_plug_template_id=>wwv_flow_imp.id(23509689171010547)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23510237902010547)
,p_plug_template_id=>wwv_flow_imp.id(23509689171010547)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23510559623010547)
,p_plug_template_id=>wwv_flow_imp.id(23509689171010547)
,p_name=>'Button Start'
