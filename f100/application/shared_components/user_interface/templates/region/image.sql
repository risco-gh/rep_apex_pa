...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23463663916010570)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23463952570010570)
,p_plug_template_id=>wwv_flow_imp.id(23463663916010570)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23464286594010570)
,p_plug_template_id=>wwv_flow_imp.id(23463663916010570)
,p_name=>'Sub Regions'
