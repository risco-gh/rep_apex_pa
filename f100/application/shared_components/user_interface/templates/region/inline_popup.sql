...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23502162161010551)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23502498876010551)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23502710327010551)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23503098868010551)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23503313414010551)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23503697479010550)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23503981730010550)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23504213218010550)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23504564096010550)
,p_plug_template_id=>wwv_flow_imp.id(23502162161010551)
,p_name=>'Sub Regions'
