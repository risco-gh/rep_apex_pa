...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23494005082010555)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23494393272010555)
,p_plug_template_id=>wwv_flow_imp.id(23494005082010555)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23494695002010555)
,p_plug_template_id=>wwv_flow_imp.id(23494005082010555)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23494908932010554)
,p_plug_template_id=>wwv_flow_imp.id(23494005082010555)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23495285436010554)
,p_plug_template_id=>wwv_flow_imp.id(23494005082010555)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23495579176010554)
,p_plug_template_id=>wwv_flow_imp.id(23494005082010555)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
