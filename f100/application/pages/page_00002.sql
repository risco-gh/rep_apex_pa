...
'union',
'select 19 value, ''param_19'' name, 2 ord from dual',
'union',
'select 15 value, ''param_15'' name, 3 ord from dual',
'union',
'select 4 value, ''param_2'' name, 4 ord from dual',
'union',
'select 7 value, ''param_7'' name, 5 ord from dual',
'union',
'select 3 value, ''param_3'' name, 6 ord from dual',
'union',
'select 12 value, ''param_12'' name, 7 ord from dual',
') order by ord'))
