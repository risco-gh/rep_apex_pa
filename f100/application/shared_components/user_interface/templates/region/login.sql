...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23512170394010546)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23512488229010546)
,p_plug_template_id=>wwv_flow_imp.id(23512170394010546)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23512769651010546)
,p_plug_template_id=>wwv_flow_imp.id(23512170394010546)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23513059535010546)
,p_plug_template_id=>wwv_flow_imp.id(23512170394010546)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23513377714010546)
,p_plug_template_id=>wwv_flow_imp.id(23512170394010546)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23513648657010545)
,p_plug_template_id=>wwv_flow_imp.id(23512170394010546)
,p_name=>'Sub Regions'
