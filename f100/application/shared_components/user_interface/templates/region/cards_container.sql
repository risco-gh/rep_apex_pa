...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23477792664010563)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23478005171010563)
,p_plug_template_id=>wwv_flow_imp.id(23477792664010563)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23478339663010563)
,p_plug_template_id=>wwv_flow_imp.id(23477792664010563)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23478639610010563)
,p_plug_template_id=>wwv_flow_imp.id(23477792664010563)
,p_name=>'Sub Regions'
