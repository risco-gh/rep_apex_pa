...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23479643924010562)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23479982911010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23480227312010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23480562667010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23480853112010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23481191837010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23481415752010561)
,p_plug_template_id=>wwv_flow_imp.id(23479643924010562)
,p_name=>'Sub Regions'
