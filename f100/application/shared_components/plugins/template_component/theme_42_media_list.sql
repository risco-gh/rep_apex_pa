...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(23620786319010387)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1823638558920894031)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1823639113932894032)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23621479457010383)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23621757147010382)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23622003318010382)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23622345331010382)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23622758652010381)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23622003318010382)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1823639113932894032)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23623010218010380)
,p_plugin_attribute_id=>wwv_flow_imp.id(23622758652010381)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23623485645010380)
,p_plugin_attribute_id=>wwv_flow_imp.id(23622758652010381)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23623820730010379)
,p_plugin_attribute_id=>wwv_flow_imp.id(23622758652010381)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23624228486010379)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(23622758652010381)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23624514056010378)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23624852029010378)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23625184731010378)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23625489307010377)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23625715665010377)
,p_plugin_attribute_id=>wwv_flow_imp.id(23625489307010377)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23626136232010376)
,p_plugin_attribute_id=>wwv_flow_imp.id(23625489307010377)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23626544902010376)
,p_plugin_attribute_id=>wwv_flow_imp.id(23625489307010377)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23626972557010375)
,p_plugin_attribute_id=>wwv_flow_imp.id(23625489307010377)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23627365331010375)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(23622345331010382)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1823638558920894031)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23627618115010374)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23627967103010374)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23628220105010374)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23628596926010373)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23628837148010373)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23629181839010372)
,p_plugin_attribute_id=>wwv_flow_imp.id(23628837148010373)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23629541331010372)
,p_plugin_attribute_id=>wwv_flow_imp.id(23628837148010373)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23629913615010371)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23630237471010371)
,p_plugin_attribute_id=>wwv_flow_imp.id(23629913615010371)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23630671288010370)
,p_plugin_attribute_id=>wwv_flow_imp.id(23629913615010371)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23631078104010370)
,p_plugin_attribute_id=>wwv_flow_imp.id(23629913615010371)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23631479279010369)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23632901334010367)
,p_plugin_attribute_id=>wwv_flow_imp.id(23631479279010369)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23633338434010366)
,p_plugin_attribute_id=>wwv_flow_imp.id(23631479279010369)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23631782238010368)
,p_plugin_attribute_id=>wwv_flow_imp.id(23631479279010369)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23632120005010368)
,p_plugin_attribute_id=>wwv_flow_imp.id(23631479279010369)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23632586285010368)
,p_plugin_attribute_id=>wwv_flow_imp.id(23631479279010369)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23633749778010366)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(23634065298010366)
,p_plugin_attribute_id=>wwv_flow_imp.id(23633749778010366)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(23634478086010365)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1823842166090040660)
,p_plugin_id=>wwv_flow_imp.id(23620786319010387)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
