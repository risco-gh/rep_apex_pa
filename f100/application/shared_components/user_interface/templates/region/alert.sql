...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(23445591221010586)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23445826121010582)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23446141579010581)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23446485905010581)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23446792194010581)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23447092126010581)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(23447390252010581)
,p_plug_template_id=>wwv_flow_imp.id(23445591221010586)
,p_name=>'Sub Regions'
